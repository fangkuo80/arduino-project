...
//U8X8_SSD1306_128X32_NONAME_SW_I2C u8x8(/* clock=*/ SCL, /* data=*/ SDA, /* reset=*/ U8X8_PIN_NONE);   // OLEDs without Reset of the Display
...
void showTime(tm *localTime) 
{
  ...
  //display on OLED
  char time_output[30];
  u8x8.setFont(u8x8_font_inb21_2x4_n);//inr21_2x4_r  //inb33_3x6_n //inb21_2x4_n
//  u8x8.setFont(u8x8_font_courB21_2x4_f);
  u8x8.setCursor(0,2); //0,0
